...
export const ui = {
  en: {
    ...
    'pricing.trial.tag': '7-Day Free Trial',
    'pricing.trial.desc': 'Download the mobile application and try any of the services for 7 days, absolutely free. Manage your subscription and upgrades directly on the App Store or Play Store.',
    'pricing.download.appstore': 'Download for iOS',
    'pricing.download.playstore': 'Download for Android',
    // Contact
  ...
  es: {
    ...
    'pricing.trial.tag': 'Prueba Gratuita de 7 Días',
    'pricing.trial.desc': 'Descarga la aplicación móvil y prueba cualquiera de los servicios gratis por 7 días. Administra tu suscripción e impuestos directamente desde la App Store o Play Store.',
    'pricing.download.appstore': 'Descargar para iOS',
    'pricing.download.playstore': 'Descargar para Android',
    // Contact
